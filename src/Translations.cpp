...
namespace {
    ...
    const StringMap<std::string> english = {
        ...
        {"$SkyPromptMCPThemeEffectProgressCircle", "Progress Circle"},
        {"$SkyPromptMCPThemeEffectListIndicators", "List Indicators"},
        {"$SkyPromptMCPThemeEffectActivationPop", "Activation Pop"},
        {"$SkyPromptMCPEffectRadius", "Radius Multiplier"},
        {"$SkyPromptMCPEffectRadiusHelp", "Multiply the progress circle's radius. 1 keeps its normal size."},
        {"$SkyPromptMCPEffectThickness", "Thickness Multiplier"},
        {"$SkyPromptMCPEffectThicknessHelp", "Multiply the width of the circle's lines. 1 keeps their normal thickness."},
        {"$SkyPromptMCPEffectOffsetX", "Horizontal Offset"},
        {"$SkyPromptMCPEffectOffsetXHelp", "Shift this effect horizontally in screen pixels. Positive values move it right."},
        {"$SkyPromptMCPEffectOffsetY", "Vertical Offset"},
        {"$SkyPromptMCPEffectOffsetYHelp", "Shift this effect vertically in screen pixels. Positive values move it down."},
        {"$SkyPromptMCPEffectRotation", "Rotation"},
        {"$SkyPromptMCPEffectRotationHelp", "Rotate the circle's starting point and markers, in degrees. Positive values rotate clockwise."},
        {"$SkyPromptMCPEffectHoldSize", "Hold Marker Size"},
        {"$SkyPromptMCPEffectHoldSizeHelp", "Multiply the hold marker's size. 1 keeps its normal size."},
        {"$SkyPromptMCPEffectArcColor", "Progress Arc Color"},
        {"$SkyPromptMCPEffectCompletedColor", "Completed Color"},
        {"$SkyPromptMCPEffectTrackColor", "Track Color"},
        {"$SkyPromptMCPEffectHoldColor", "Hold Marker Color"},
        {"$SkyPromptMCPEffectRemovalColor", "Remove Marker Color"},
        {"$SkyPromptMCPEffectSkipColor", "Skip Marker Color"},
        {"$SkyPromptMCPEffectColorHelp", "Color and transparency of this part of the effect."},
        {"$SkyPromptMCPEffectShowArc", "Show Progress Arc"},
        {"$SkyPromptMCPEffectShowArcHelp", "Draw the arc that fills as an action is held."},
        {"$SkyPromptMCPEffectShowTrack", "Show Track"},
        {"$SkyPromptMCPEffectShowTrackHelp", "Draw the faint full circle behind the progress arc."},
        {"$SkyPromptMCPEffectShowHold", "Show Hold Marker"},
        {"$SkyPromptMCPEffectShowHoldHelp", "Draw the marker for hold actions."},
        {"$SkyPromptMCPEffectShowCommands", "Show Special-Command Marks"},
        {"$SkyPromptMCPEffectShowCommandsHelp", "Draw the remove and skip marks when their special commands are available."},
        {"$SkyPromptMCPEffectClockwise", "Clockwise"},
        {"$SkyPromptMCPEffectClockwiseHelp", "Fill the progress arc clockwise. Turn off to fill counterclockwise."},
        {"$SkyPromptMCPEffectIndicatorSize", "Arrow Size Multiplier"},
        {"$SkyPromptMCPEffectIndicatorSizeHelp", "Multiply the list arrows' size. 1 keeps their normal size."},
        {"$SkyPromptMCPEffectIndicatorSpacing", "Arrow Spacing"},
        {"$SkyPromptMCPEffectIndicatorSpacingHelp", "Extra space between each arrow and the visible list, in screen pixels."},
        {"$SkyPromptMCPEffectUpColor", "Up Arrow Color"},
        {"$SkyPromptMCPEffectDownColor", "Down Arrow Color"},
        {"$SkyPromptMCPEffectShowIndicators", "Show Arrows"},
        {"$SkyPromptMCPEffectShowIndicatorsHelp", "Show arrows when more list prompts are hidden above or below."},
        {"$SkyPromptMCPEffectPopDuration", "Duration"},
        {"$SkyPromptMCPEffectPopDurationHelp", "Length of the activation pop, in seconds."},
        {"$SkyPromptMCPEffectPopScale", "End Scale"},
        {"$SkyPromptMCPEffectPopScaleHelp", "Final scale of the expanding copy. 1 keeps its original size."},
        {"$SkyPromptMCPEffectPopOpacity", "Opacity"},
        {"$SkyPromptMCPEffectPopOpacityHelp", "Starting opacity of the expanding copy, from 0 (invisible) to 1 (opaque)."},
        {"$SkyPromptMCPEffectPopIconOnly", "Icon Only"},
        {"$SkyPromptMCPEffectPopIconOnlyHelp", "Animate only the button icon, without the text."},
        ...
        {"$SkyPromptMCPDeviceGamepad", "Gamepad"},
        ...
        {"$SkyPromptMCPControlsNavigationModifier", "Navigation Modifier"},
        {"$SkyPromptMCPControlsNavigationModifierHelp",
         "Hold this button and use the left stick or trackpad. Up/down selects prompts; left/right switches between mods."},
        {"$SkyPromptMCPControlsNone", "None"},
        {"$SkyPromptMCPVRUp", "Up"},
        {"$SkyPromptMCPVRDown", "Down"},
        {"$SkyPromptMCPVRLeft", "Left"},
        {"$SkyPromptMCPVRRight", "Right"},
        {"$SkyPromptMCPVRLeftStickClick", "Left Stick Click"},
        {"$SkyPromptMCPVRRightStickClick", "Right Stick Click"},
        {"$SkyPromptMCPVRLeftGrip", "Left Grip"},
        {"$SkyPromptMCPVRRightGrip", "Right Grip"},
        {"$SkyPromptMCPVRLeftTrigger", "Left Trigger"},
        {"$SkyPromptMCPVRRightTrigger", "Right Trigger"},
